...
Route::group(['namespace' => 'Frontend'], function() {
    ...
    Route::get('san-pham/{id}','ProductDetailController@generateQrCode')->name('get.product.generateQrCode');
    Route::get('san-pham/mobile/{slug}','DetailMobileController@getProductDetailMobile')->name('get.product.detailmobile');
...
Route::get('/mapr', 'QRCodeController@generateQRCode')->name('maqr');
